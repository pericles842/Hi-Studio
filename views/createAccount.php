   ...
   <div class="box-backgraund">
      <div class="box-login">
         ...
         <div class="box-inputs">
            <form action="../php/i.createAccount.php" method="post">
               <h1>Crear Cuenta</h1>
               <p>Usuario</p>
               ...
               <br>
               <p>Email</p>
               <input type="email" class="form-control" name="email" placeholder="Ej. usuario@mail.com" required>
               <br>
               <input type="submit" class="btn btn-primary btn-lg btn-block " value="Enviar">
               <div class="box-link">
                  <p>¿Ya tienes una cuenta?</p>
                  <a href="../login.php" class="alert-link">Inicia sesion</a>
               </div>
            </form>
         </div>
      </div>

        ...
        <div class="spinner-border" role="status">
            ...
            <section>
                <div class="container-fluid">
                    <div class="menu">
                        <h3 class="dropdown-header">Opciones de registro</h3>
                        <a class="dropdown-item" href="reg_materias.php">Registro de Materias</a>
                        <a class="dropdown-item " href="reg_facturas.php">Registro de Facturas</a>
                        <a class="dropdown-item" href="reg_actividades.php">Registro de actividadades</a>
                  </div>
              </div>
            </section>
            <div>
